...
1) Кредит наличными
   → подходит, если расходы/исходящие переводы значительно превышают баланс.  

2) Депозит Мультивалютный
   → выгоден клиентам, у которых есть доходы или переводы в разных валютах.  

3) Депозит Сберегательный
   → для клиентов, которые копят деньги и не планируют тратить их в ближайшее время.  

4) Депозит Накопительный
   → для клиентов с регулярными доходами и расходами, которые хотят откладывать постепенно.  
...
8) Если среднемесячный остаток меньше 150 000 тенге, не стоит рекомендовать продукты 3)Депозит Мультивалютный и 4)Депозит Накопительный.
